 ...
 * Team members page — business_users table is not in the simplified schema yet.
 * Shows the current owner and a "coming soon" notice for multi-user support.
 */
        ...
        {ownerEmail && (
          <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
            <div className="flex items-center gap-4 px-5 py-4">
              <div className="bg-blue-500/20 rounded-full w-11 h-11 flex items-center justify-center shrink-0">
                <Users size={20} className="text-blue-400" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-base font-semibold text-white truncate">{ownerEmail}</p>
