    ...
    <div className="pb-6">
      ...
      <div className="sticky top-0 bg-[#0a0a0a]/90 backdrop-blur-xl border-b border-white/10 z-10 px-4 pt-5 pb-3 space-y-3">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold text-white">🏭 Supplier Ledger</h1>
          {atLimit ? (
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-sm font-medium text-blue-400">Total Suppliers</p>
            </div>
          ...
          <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-sm font-medium text-red-400">Total Amount Due</p>
            </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-xl font-semibold text-gray-500">
              {search ? 'No supplier found' : 'No suppliers added yet'}
            </p>
            {!search && (
              <p className="text-sm text-gray-600 mt-2">Tap "+ Add" above</p>
            )}
          </div>
        ) : (
                    ...
                    <div className="flex items-center gap-2 ml-2 shrink-0">
                      <div className="text-right">
                        <span className={`text-xs font-semibold px-2 py-1 rounded-full ${colors.badge}`}>
                          {outstanding === 0 ? '✓ Paid' : `NPR ${outstanding.toLocaleString('ne-NP')}`}
                        </span>
                        {outstanding > 0 && (
                          <p className="text-xs text-gray-600 mt-0.5 text-right">Amount Due</p>
                        )}
                      </div>
